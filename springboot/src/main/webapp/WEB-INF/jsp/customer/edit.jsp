                        ...
                        <div class="row align-items-center justify-content-center pt-3">
                            ...
                            <div class="col-4">
                                <input type="text"
                                       id="addressLine2Id"
                                       name="addressLine2"
                                       class="form-control <c:if test="${bindingResult.hasFieldErrors('addressLine2')}">is-invalid</c:if>"
                        ...
                        <div class="row align-items-center justify-content-center pt-3">
                            ...
                            <div class="col-4">
                                <input type="text"
                                       id="postalCodeId"
                                       name="postalCode"
                                       class="form-control <c:if test="${bindingResult.hasFieldErrors('postalCode')}">is-invalid</c:if>"
